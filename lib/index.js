...
function fn(metadataGetter, dataAdapter, opts = {}) {
    if (typeof metadataGetter !== 'function' || typeof dataAdapter !== 'function') {
        throw new Error(`'metadataGetter' and 'dataAdapter' must be function types.`);
    }
